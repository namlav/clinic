      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            ...
            child: const Icon(Icons.search, size: 23, color: Color(0xFF0057C2)),
          ),
        ],
      ),
    );
            ...
            children: [
              ...
              Wrap(
                ...
                children: List.generate(31, (index) {
                  int day = index + 1;
                  DateTime itemDate = DateTime(currentDate.year, currentDate.month, day);
      ...
      children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            bool isSelected = selectedTimeIndex != null && selectedTimeIndex == index;
